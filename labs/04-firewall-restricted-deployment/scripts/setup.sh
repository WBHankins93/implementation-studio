#!/bin/bash
# Setup script for Lab 04: Firewall-Restricted Deployment (GCP or AWS)
...
echo "🚀 Setting up Lab 04: Firewall-Restricted Deployment"
echo ""
...
echo "4. After apply, get proxy IP: terraform output proxy_internal_ip"
echo "5. Update manifests/proxy-configmap.yaml with proxy IP (or use deploy script)"
echo "6. Run: ./scripts/deploy-argo.sh"
